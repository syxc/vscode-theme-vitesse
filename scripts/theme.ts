...
export default function getTheme(options: GetThemeOptions) {
  ...
  const theme = {
    ...
    colors: {
      ...
      'list.hoverBackground': isGithub ? VitesseThemes.githubListHoverBackground : (isBlack && isSoft ? VitesseThemes.blackSoftListHoverBackground : (isBlack ? VitesseThemes.blackListHoverBackground : (isLight ? VitesseThemes.lightListHoverBackground : VitesseThemes.darkListHoverBackground))),
      'list.inactiveSelectionBackground': isGithub ? VitesseThemes.githubListInactiveSelectionBackground : (isBlack && isSoft ? VitesseThemes.blackSoftListInactiveSelectionBackground : (isBlack ? VitesseThemes.blackListInactiveSelectionBackground : (isLight ? VitesseThemes.lightListInactiveSelectionBackground : VitesseThemes.darkListInactiveSelectionBackground))),
      'list.activeSelectionBackground': isGithub ? VitesseThemes.githubListActiveSelectionBackground : (isBlack && isSoft ? VitesseThemes.blackSoftListActiveSelectionBackground : (isBlack ? VitesseThemes.blackListActiveSelectionBackground : (isLight ? VitesseThemes.lightListActiveSelectionBackground : VitesseThemes.darkListActiveSelectionBackground))),
