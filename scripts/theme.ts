...
export default function getTheme(options: GetThemeOptions) {
  ...
  const theme = {
    ...
    colors: {
      ...
      'list.hoverBackground': isBlack && isSoft ? VitesseThemes.blackSoftListHoverBackground : (isBlack ? VitesseThemes.blackListHoverBackground : (isLight && isSoft ? VitesseThemes.lightSoftListHoverBackground : (isGithub ? VitesseThemes.githubListHoverBackground : (isLight ? VitesseThemes.lightListHoverBackground : (isSoft ? VitesseThemes.darkSoftListHoverBackground : VitesseThemes.darkListHoverBackground))))),
      'list.inactiveSelectionBackground': isBlack && isSoft ? VitesseThemes.blackSoftListInactiveSelectionBackground : (isBlack ? VitesseThemes.blackListInactiveSelectionBackground : (isLight && isSoft ? VitesseThemes.lightSoftListInactiveSelectionBackground : (isGithub ? VitesseThemes.githubListInactiveSelectionBackground : (isLight ? VitesseThemes.lightListInactiveSelectionBackground : (isSoft ? VitesseThemes.darkSoftListInactiveSelectionBackground : VitesseThemes.darkListInactiveSelectionBackground))))),
      'list.activeSelectionBackground': isBlack && isSoft ? VitesseThemes.blackSoftListActiveSelectionBackground : (isBlack ? VitesseThemes.blackListActiveSelectionBackground : (isLight && isSoft ? VitesseThemes.lightSoftListActiveSelectionBackground : (isGithub ? VitesseThemes.githubListActiveSelectionBackground : (isLight ? VitesseThemes.lightListActiveSelectionBackground : (isSoft ? VitesseThemes.darkSoftListActiveSelectionBackground : VitesseThemes.darkListActiveSelectionBackground))))),
